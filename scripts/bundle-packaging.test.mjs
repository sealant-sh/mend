...
test("the bundle pins published Sealant 0.31.1 artifacts and its official migrator", async () => {
  ...
  assert.equal(contract.sealantVersion, "0.31.1");
  ...
  assert.match(dockerfile, /sealant-api@sha256:e5dab6fd/);
  assert.match(dockerfile, /sealant-worker@sha256:5dfafa7e/);
  assert.match(dockerfile, /sealant-ssh-gateway@sha256:341e24ae/);
