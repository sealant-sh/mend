...
- **Mend change:** preserve the platform's runtime-specific refusal instead of replacing every
  ...
  recipe or another immutable platform revision and still pins Mend's coding tools. Its default
  recipe now comes from the immutable Sealant 0.33.0 release commit.
